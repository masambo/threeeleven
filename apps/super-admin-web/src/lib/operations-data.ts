...
export const adminNavItems = [
  ...
  { label: "Emergency queue", href: "/dashboard/emergency", icon: ShieldAlert },
...
export const mapMarkers = [
  { label: "Windhoek", left: "52%", top: "40%", tone: "emergency", count: "3", layer: "emergency" },
  { label: "Swakopmund", left: "42%", top: "36%", tone: "warning", count: "5", layer: "report" },
  { label: "Walvis Bay", left: "39%", top: "48%", tone: "brand", count: "2", layer: "zone" },
  { label: "Rundu", left: "67%", top: "24%", tone: "safety", count: "1", layer: "region" },
  { label: "Keetmanshoop", left: "55%", top: "72%", tone: "warning", count: "4", layer: "report" },
] satisfies MapMarker[];
...
export const emergencyAlerts = [
  ["PAN-1018", "Panic", "Windhoek", "Active", "3 min ago", "Dispatch"],
  ["MED-1042", "Medical", "Rundu", "Responding", "12 min ago", "Track"],
  ["FIR-1092", "Fire", "Walvis Bay", "Active", "18 min ago", "Dispatch"],
